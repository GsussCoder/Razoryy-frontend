...
export default function AdminLayout() {
  ...
  const topNavItems = filterItems(TOP_NAV_ITEMS);
  const bottomNavItems = filterItems(BOTTOM_NAV_ITEMS);
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col lg:flex-row">
      ...
      <aside
        className={`
          fixed lg:sticky top-0 bottom-0 left-0 z-40 w-64 bg-slate-800 border-r border-slate-700 
          flex flex-col h-screen transform transition-transform duration-200 ease-in-out lg:transform-none
          pt-14.25 lg:pt-0
